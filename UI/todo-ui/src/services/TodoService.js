...
const BASE_REST_API_URL = 'http://localhost:8080/cloudvendor/';
...
export const saveTodo = (cloudvendor) => axios.post(BASE_REST_API_URL, cloudvendor)

export const getTodo = (id) => axios.get(BASE_REST_API_URL + '/' + id)

export const updateTodo = (id, cloudvendor) => axios.put(BASE_REST_API_URL + '/' + id, cloudvendor)
